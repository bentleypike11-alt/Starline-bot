    ...
    <div className="min-h-screen bg-background text-foreground pb-20">
      ...
      >
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          >
            <div
              className="w-8 h-8 rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-sm"
              style={{
                background:
      ...
      <main className="max-w-6xl mx-auto px-4 pt-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Choose a server to manage, or add StarLine to a new one.
          </p>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 bg-card rounded-3xl border border-border shadow-sm">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm mx-auto text-sm">
              You don't have Manage Server permissions in any
              servers, or the bot hasn't been added yet.
            </p>
...
function ServerCard({
  ...
  return (
    <div
      className={`group relative bg-card rounded-2xl border p-6 flex flex-col items-center text-center transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md ${
        guild.isPremium
    ...
    >
      ...
      {iconUrl ? (
        ...
        <div
          className="w-20 h-20 rounded-2xl flex items-center justify-center mb-4 text-white font-bold text-2xl"
          style={{
            background:
              "linear-gradient(135deg, #d4af37, #ffd700)",
          }}
      ...
      {/* Server Name */}
      <h3
        className="text-base font-bold leading-tight mb-1 truncate w-full px-2"
        title={guild.name}
      >
        {guild.name}
      </h3>
